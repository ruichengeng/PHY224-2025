...
plt.subplot(2, 1, 2)
plt.plot(lin_year, lin_zero_err, label="Zero residual line")
plt.errorbar(lin_year, lin_residual, yerr=lin_unc, fmt='o', capsize=0, ecolor = "red", label = "Residual of the linear model versus actual data", marker = ".", markersize = 10)
plt.xlabel("Year")
...
plt.errorbar(year, quad_residual, yerr=unc, fmt='o', capsize=0, ecolor = "red", label = "Residual of the quadratic model versus actual data", marker = ".", markersize = 10)
plt.xlabel("Year")
...
plt.subplot(2, 1, 2)
plt.plot(year, zero_residual_line, label="Zero residual line")
plt.errorbar(year, pow_residual, yerr=unc, fmt='o', capsize=0, ecolor = "red", label = "Residual of the power model versus actual data", marker = ".", markersize = 10)
plt.xlabel("Year")
